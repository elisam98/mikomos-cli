...
function program3(depth0,data) {
  ...
  data.buffer.push("<img src=\"assets/images/mikomos_banner.svg\" style=\"height:50px\">");
  }
...
function program5(depth0,data) {
  ...
  stack1 = helpers['if'].call(depth0, "needsFilter", {hash:{},hashTypes:{},hashContexts:{},inverse:self.noop,fn:self.program(5, program5, data),contexts:[depth0],types:["ID"],data:data});
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
  data.buffer.push("\n			</div>\n		</div> \n	</div> \n</nav>\n<div class=\"container\">\n	");
