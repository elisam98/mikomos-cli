...
function program3(depth0,data) {
  ...
  data.buffer.push(escapeExpression(helpers.action.call(depth0, "showFilter", {hash:{},hashTypes:{},hashContexts:{},contexts:[depth0],types:["STRING"],data:data})));
  data.buffer.push(">\n			<span class=\"\">\n				<i class=\"glyphicon glyphicon-filter\"></i>\n				Filter\n			</span>\n		</button>\n	</div>\n</div>\n<hr>\n");
  data.buffer.push(escapeExpression(helpers.view.call(depth0, "filter-modal", {hash:{},hashTypes:{},hashContexts:{},contexts:[depth0],types:["STRING"],data:data})));
